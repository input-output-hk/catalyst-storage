...
snapshot_path = os.path.join(os.path.dirname(__file__), "../snapshot-80000000-preprod.json")
...
# write into a file
write_file_path = os.path.join(os.path.dirname(__file__), "../cardano-asset-80000000-preprod.json")
